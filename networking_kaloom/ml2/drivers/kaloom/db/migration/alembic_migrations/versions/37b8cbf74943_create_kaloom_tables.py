...
def downgrade():
    op.drop_table('kaloom_ml2_knid_mapping')
    op.drop_table('kaloom_ml2_vlan_host_mapping')
    op.drop_table('kaloom_ml2_vlan_reservation')
    op.drop_table('kaloom_ml2_tp_operation')
